...
ALIASES = {
    ...
    "name": ["商品名", "商品名称", "商品标题", "name", "title", "product name"],
    "price": ["价格", "价格(usd)", "price", "售价", "price_usd"],
    "sales7": ["周期销量", "周期销量(件)", "7天销量", "近7天销量", "销量(7天)",
               "sales", "7d sales", "weekly sales", "周销量"],
    "gmv7": ["周期gmv", "7天gmv", "近7天gmv", "gmv", "7d gmv", "weekly gmv", "周期销售额"],
    "sales_total": ["总销量", "累计销量", "total sales", "total sold", "销量"],
    "gmv_total": ["总gmv", "累计gmv", "total gmv"],
    "commission": ["佣金率", "佣金", "commission", "commission rate", "达人佣金"],
    "listed_days": ["上架天数", "上架时间", "上架日期", "listing days", "listed at",
                    "created at", "上架"],
